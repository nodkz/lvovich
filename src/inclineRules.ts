...
export function getDeclensionConst(key?: DeclentionStrT | string | null): DeclentionT | null {
  switch (key) {
    case 'nominative':
    case NOMINATIVE:
      return NOMINATIVE;
...
export function getDeclensionStr(cnst: DeclentionT | string | null): DeclentionStrT | null {
  switch (cnst) {
    case 'nominative':
    case NOMINATIVE:
      return 'nominative';
